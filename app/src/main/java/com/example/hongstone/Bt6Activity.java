...
public class Bt6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataList = helper.selecta("SELECT tfcwkerMvmnCnterNm, latitude, longitude FROM MOVE WHERE rdnmadr LIKE '%전라%';");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent intent = new Intent(Bt6Activity.this, MainActivity.class); // 메인 -> sub
