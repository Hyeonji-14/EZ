...
public class Bt1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataList = helper.selecta("SELECT tfcwkerMvmnCnterNm, latitude, longitude FROM MOVE WHERE rdnmadr LIKE '%서울%';");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent intent = new Intent(Bt1Activity.this, MainActivity.class); // 메인 -> sub
